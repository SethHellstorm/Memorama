...
namespace Memorama
{
    public partial class Bienvenida : Form
    {
        ...
        string[,] memoriaInicial = new string[5, 5]; //Instanciamos e inicializamos el arreglo de 5 por 5 el cual contendrá los puntajes más altos.
        public Bienvenida()
        {
        ...
        { //Funcion de lcik para el boton de iniciar
            memoriaInicial[0, 0] = "Rafael"; //Rellenamos el arreglo con la información base, damos nombre
            memoriaInicial[0, 1] = "Seth"; // Damos nickname
            memoriaInicial[0, 2] = "29"; // Damos edad
            memoriaInicial[0, 3] = "85"; //Damos movimientos
            memoriaInicial[0, 4] = "00:15:31"; // Damos tiempo en el formato Horas:Minutos:Segundos
            ...
            memoriaInicial[1, 4] = "22:58:58"; // Damos tiempo en el formato Horas:Minutos:Segundos
            ...
            memoriaInicial[2, 4] = "22:58:58"; // Damos tiempo en el formato Horas:Minutos:Segundos
            ...
            memoriaInicial[3, 4] = "22:58:58"; // Damos tiempo en el formato Horas:Minutos:Segundos
            ...
            memoriaInicial[4, 4] = "22:58:58"; // Damos tiempo en el formato Horas:Minutos:Segundos
